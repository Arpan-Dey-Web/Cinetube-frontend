      ...
      <div className="pt-2">
        {status === "PREMIUM" && !hasAccess ? (
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <Button onClick={handlePurchase} className="w-full h-14 bg-primary text-primary-foreground hover:bg-primary/90 font-black uppercase italic tracking-widest rounded-xl transition-all active:scale-95 shadow-lg shadow-primary/20">
